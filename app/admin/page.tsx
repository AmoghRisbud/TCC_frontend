        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-brand-muted mb-8">
              This admin section displays the content management capabilities that will be available
              on this platform. These features are currently in preview mode. To enable full admin
              functionality, contact us to request appropriate access permissions for your role.
            </p>
