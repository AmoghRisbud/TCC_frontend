...
export const metadata = { title: 'Contact | TCC' };
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-white/80 leading-relaxed">
              Have questions or want to learn more about TCC? We&apos;d love to hear from you.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {contactMethods.map((method) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-brand-dark mb-2">{method.title}</h3>
                  <p className="text-sm text-brand-muted mb-3">{method.description}</p>
                  <span className="text-brand-primary font-medium text-sm">{method.value}</span>
                </a>
              ))}
            </div>
            ...
            <div className="card max-w-2xl mx-auto">
              <h2 className="h3 mb-6 text-center text-brand-dark">Send Us a Message</h2>
              ...
              <p className="text-center text-sm text-brand-muted mt-6">
                Alternatively, email us directly at info.thecollectivecounsel@gmail.com
              </p>
            </div>
          </div>
        </div>
